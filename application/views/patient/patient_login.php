	...
	<!-- Nav bar ends here -->
		...
		<div>
			...
			<main>
				...
				<div>
			<header class="jumbotron"><h1 align="center">Sign in as a Patient</h1></header>
		</div>
				...
				<div class="col-lg-6 border-right">
					...
					<form method="post" action="" enctype="multipart/form-data" autocomplete="off">
						...
						<div class="form-group">
							...
							<label>Email : </label>
							<input type="text" name="patient_email" placeholder="Enter your email-id." class="form-control" required>

						</div>
						<div class="form-group">
							
							<label>Password : </label>
							<input type="text" name="patient_password" placeholder="password." class="form-control" required>
