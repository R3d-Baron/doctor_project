				...
				<div class="col-lg-6 border-right">
					...
					<form method="post" action="insertAction.php" enctype="multipart/form-data" autocomplete="off">
						...
						<div class="form-group">
							...
							<input type="text" name="password" placeholder="Create new password." class="form-control" required>
						...
						<div class="form-group">
							...
							<input type="text" name="alt-mobile" placeholder="Enter your Alternate Mobile no." class="form-control" required>
						</div>
						<div class="form-group">
							<label>Address : </label>
						...
						<div class="form-group">
							...
							<div class="form-check form-check-inline">
  								<input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="lang[1]" value="Bengali">
  								<label class="form-check-label" for="inlineCheckbox1">Bengali</label>
							</div>
							<div class="form-check form-check-inline">
  								<input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="lang[2]" value="English" required>
  								<label class="form-check-label" for="inlineCheckbox2">English</label>
							</div>
							<div class="form-check form-check-inline">
  								<input class="form-check-input" type="checkbox" id="inlineCheckbox3" name="lang[3]" value="Hindi">
  								<label class="form-check-label" for="inlineCheckbox3">Hindi</label>
							</div>
							<div class="form-check form-check-inline">
  								<input class="form-check-input" type="checkbox" id="inlineCheckbox4" name="lang[4]" value="Others" disabled>
						...
						<div class="form-group">
							...
							<input type="file" name="upload-img" class="form-control" required>
